      ...
      <section className="py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          {isSuccess && (
            ...
            >
              <Card className="bg-gradient-to-r from-green-500/10 to-transparent border-green-500/20 p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-2 text-[var(--accent-yellow)] text-glow">Challenge Received!</h3>
            ...
            <Card className="bg-[var(--bg-card)] border-gray-900 p-8 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-lg font-semibold text-[var(--accent-yellow)]">
                    Your Name *
                  </Label>
                  <Input
                    id="name"
                ...
                {/* Email */}
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-lg font-semibold text-[var(--accent-yellow)]">
                    Email Address *
                  </Label>
                  <Input
                    id="email"
                ...
                {/* Company */}
                <div className="space-y-2">
                  <Label htmlFor="company" className="text-lg font-semibold text-[var(--accent-yellow)]">
                ...
                {/* Task Description */}
                <div className="space-y-2">
                  <Label htmlFor="task_description" className="text-lg font-semibold text-[var(--accent-yellow)]">
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h3 className="text-2xl font-bold text-center mb-8 text-[var(--accent-yellow)] text-glow">What Happens Next?</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-[var(--bg-card)] border-gray-900 p-6 text-center">
                ...
                <h4 className="font-bold mb-2 text-white">Instant AI Analysis</h4>
                <p className="text-sm text-gray-400">
              ...
              <Card className="bg-[var(--bg-card)] border-gray-900 p-6 text-center">
                ...
                <h4 className="font-bold mb-2 text-white">Personal Review</h4>
                <p className="text-sm text-gray-400">
              ...
              <Card className="bg-[var(--bg-card)] border-gray-900 p-6 text-center">
                ...
                <h4 className="font-bold mb-2 text-white">Strategic Call</h4>
                <p className="text-sm text-gray-400">
