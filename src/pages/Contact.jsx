        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
              ...
              {!isSuccess ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-base font-medium text-[#F5F5F5]">
                      Your Name *
                    </Label>
                    <Input
                      id="name"
                  ...
                  {/* Email */}
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-base font-medium text-[#F5F5F5]">
                      Email Address *
                    </Label>
                    <Input
                      id="email"
                  ...
                  {/* Company */}
                  <div className="space-y-2">
                    <Label htmlFor="company" className="text-base font-medium text-[#F5F5F5]">
                  ...
                  {/* Task Description */}
                  <div className="space-y-2">
                    <Label htmlFor="task_description" className="text-base font-medium text-[#F5F5F5]">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Every day, I manually copy data from customer emails into our CRM, categorize them by urgency, and send follow-up emails. This takes 2-3 hours daily..."
                      className="bg-[#111111] border-[#333333] text-[#F5F5F5] placeholder:text-[#A0A0A0] focus:border-[#CCFF00] min-h-[200px] resize-none"
                    />
                  ...
                  <Button
                    ...
                    className="w-full bg-[#CCFF00] hover:bg-[#CCFF00] text-black font-bold py-6 text-lg button-hover disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <>
          ...
          {!isSuccess && (
            <motion.div
              ...
              className="mt-16"
            >
              <h3 className="text-2xl font-bold text-center mb-10 text-[#F5F5F5]">What Happens Next?</h3>
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="bg-[#1A1A1A] border-[#333333] p-6 text-center">
                  <div className="w-12 h-12 bg-[#CCFF00]/10 rounded-full flex items-center justify-center mx-auto mb-4 border border-[#CCFF00]/20">
                    <span className="text-xl font-bold text-[#CCFF00]">1</span>
                  </div>
                  <h4 className="font-semibold mb-2 text-[#F5F5F5]">Instant AI Analysis</h4>
                  <p className="text-sm text-[#A0A0A0]">
                ...
                <Card className="bg-[#1A1A1A] border-[#333333] p-6 text-center">
                  ...
                  <h4 className="font-semibold mb-2 text-[#F5F5F5]">Personal Review</h4>
                  <p className="text-sm text-[#A0A0A0]">
                ...
                <Card className="bg-[#1A1A1A] border-[#333333] p-6 text-center">
                  ...
                  <h4 className="font-semibold mb-2 text-[#F5F5F5]">Strategic Call</h4>
                  <p className="text-sm text-[#A0A0A0]">
