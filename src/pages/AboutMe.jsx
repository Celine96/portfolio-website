        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-bold text-[#F5F5F5]">My Journey into Automation</h2>
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl font-bold mb-12 text-center text-[#F5F5F5]">
              ...
              {values.map((value, index) => (
                ...
                >
                  <Card className="bg-[#1A1A1A] border-[#333333] p-8 h-full card-hover">
                    ...
                    <h3 className="text-xl font-semibold mb-3 text-[#F5F5F5]">{value.title}</h3>
